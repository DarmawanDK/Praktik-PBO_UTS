...
// Gcc cgi.c -o cgi
// ./cgi --target=../dokumen/test_get.php --method=GET --data_query_string="nama=darmawan&alamat=ngawi"
// cara memanggil test.post.php
// Gcc cgi.c -o cgi
//./cgi --target=../dokumen/test_post.php --method=POST --data_post="username=d4824trojan02@g&passwd=234"

//.\cgi.exe --target=../dokumen/test_get.php --method=GET --data_query_string="nama=darmawan&alamat=ngawi"